...
/**
 * Capability checker for Minecraft 1.20.x.
 */
public class Mc120xCapabilityChecker implements ICapabilityChecker {
    ...
    public boolean hasCapability(VersionCapability capability) {
        return switch (capability) {
            ...
            case CUSTOM_RENDER_PIPELINE -> false; // Not available in 1.20.x
    ...
    public String getCapabilityVersion(VersionCapability capability) {
        return hasCapability(capability) ? "1.20.x" : null;
    }
}
