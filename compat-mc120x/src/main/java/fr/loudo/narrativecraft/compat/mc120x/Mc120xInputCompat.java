...
/**
 * MC 1.20.x implementation of input compatibility.
 * Uses direct GLFW calls since KeyEvent/MouseButtonEvent don't exist in 1.20.x.
 */
public class Mc120xInputCompat implements IInputCompat {
    ...
    public NcKeyEvent toNcKeyEvent(Object nativeEvent) {
        // In 1.20.x there's no KeyEvent class - events are raw parameters
    ...
    public NcMouseEvent toNcMouseEvent(Object nativeEvent) {
        // In 1.20.x there's no MouseButtonEvent class - events are raw parameters
