...
/**
 * Camera compatibility implementation for Minecraft 1.20.x.
 * Uses reflection for protected method access.
 */
public class Mc120xCameraCompat implements ICameraCompat {
