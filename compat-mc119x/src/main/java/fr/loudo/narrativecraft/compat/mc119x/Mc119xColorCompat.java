...
/**
 * Color compatibility implementation for MC 1.19.x.
 * Manual implementation since net.minecraft.util.ARGB doesn't exist in 1.19.x.
 */
public class Mc119xColorCompat implements IColorCompat {
