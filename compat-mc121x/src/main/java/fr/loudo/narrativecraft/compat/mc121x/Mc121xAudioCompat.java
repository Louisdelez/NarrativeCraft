...
/**
 * Audio compatibility implementation for Minecraft 1.21.x.
 * Uses the SoundManager and SoundEngine APIs.
 *
 * Note: This is a stub implementation. Full implementations will be
 * added as the multi-version support is completed.
 */
public class Mc121xAudioCompat implements IAudioCompat {
    ...
    public void pauseAll() {
        // SoundManager.pause() may not exist in all MC versions
    }

    @Override
    public void resumeAll() {
        // SoundManager.resume() may not exist in all MC versions
    }
