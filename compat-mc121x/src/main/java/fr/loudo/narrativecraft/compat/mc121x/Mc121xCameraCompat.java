...
/**
 * Camera compatibility implementation for Minecraft 1.21.x.
 * Uses reflection for protected method access.
 */
public class Mc121xCameraCompat implements ICameraCompat {

    // Cache reflection members
    ...
    public void setDetached(Object camera, boolean detached) {
        // Camera detachment is controlled via the setup method in vanilla
        // This is typically handled by mixin
    }
    ...
    public float[] getLeftVector(Object camera) {
        ...
        try {
            // 1.21.x uses leftVector() which returns Vector3fc
    ...
    public float[] getUpVector(Object camera) {
        Camera cam = (Camera) camera;
        try {
            // 1.21.x uses upVector() which returns Vector3fc
            org.joml.Vector3fc up = cam.upVector();
